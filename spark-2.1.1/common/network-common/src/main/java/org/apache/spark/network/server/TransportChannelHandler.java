...
public class TransportChannelHandler extends ChannelInboundHandlerAdapter {
  ...
  // 当TransportChannelHandler读取的request是RequestMessage时，则将此消息的处理进一步交给TransportRequestHandler，
  // 当读取的request是 ResponseMessage时，则将此消息的处理进一步交给TransportResponseHandler。
  @Override
